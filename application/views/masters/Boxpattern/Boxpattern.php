					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="medicine_BoxName" placeholder="Medicine Box Pattern" required="required">
							</div>
						</div>
							<div class="col-md-6">
							<div class="form-group">
								<label class="form-label">Medicine Number Per Box *</label>
								<input type="text" class="form-control" name="medicne_numberPerBox" placeholder="Medicine Number Per Box" required="required">
							</div>
							</div>
						...
						<table id="example" class="table table-striped table-bordered text-nowrap w-100">
							<thead>
								<tr>
									...
									<th class="wd-10p">Medicine Number Per Box</th>
							...
							<tbody>
								...
								?>
											<tr>
												...
												<td><?php echo $boxpatterns['medicne_numberPerBox'];?></td>
												<td>
		                  	<?php 
