					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="manufacturerName" value="<?php echo $manufacturers[0]['manufacturerName'];?>" placeholder="Manufacture Name"  required="required">
                                <input type="hidden" name="manufacturerId" value="<?php echo $manufacturers[0]['manufacturerId'];?>">
                            </div>
						</div>
