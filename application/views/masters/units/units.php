					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="unitName" placeholder="Unit Name" required="required">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label class="form-label">Unit Symbol *</label>
								<input type="text" class="form-control" name="unitSymbol" placeholder="Unit Symbol" required="required">
							</div>
						</div>
					</div>
					<div class="row">
