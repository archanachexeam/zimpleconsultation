					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="labTestName" placeholder="Test Name" required="required">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label class="form-label">Description *</label>
								<input type="text" class="form-control" name="labTestDescription" placeholder="Description" required="required">
							</div>
						</div>
					</div>
					<div class="row">
