...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="login-img">
      ...
      <!-- PAGE -->
      <div class="page" style="background-image: url('<?php echo base_url()?>assets/images/backgrounds/doctor.jpg'); background-size: contain; background-size: cover; background-position: center; background-repeat: no-repeat;">
        <div class="">
            <!-- CONTAINER OPEN -->
