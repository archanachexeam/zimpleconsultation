      ...
      <div class="col-lg-6 col-md-12 col-sm-12 col-xl-6">
        <div class="card card-box-clr">
          <div class="card-body text-center statistics-info">
            ...
            <h6 class=" mb-0 card-box-head"><?php echo $this->lang->line('myBookingsCount'); ?></h6>
        </div>
      </div>
      <div class="col-lg-6 col-md-12 col-sm-12 col-xl-6">
        <div class="card card-box-clr">
          <div class="card-body text-center statistics-info">
            ...
            <h2 class="mt-4 mb-0 number-font"><?php echo $familyMembersCount;?></h2>
          </div>
            <h6 class=" mb-0 card-box-head"><?php echo $this->lang->line('familyMembersAdded'); ?></h6>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="col-12 col-sm-12">
        <div class="card ">
          <div class="card-header card-box-head-t">
            <h3 class="card-title mb-0"><?php echo $this->lang->line('myrecentBookings'); ?></h3>
          </div>
          <div class="card-body">
