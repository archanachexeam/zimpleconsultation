...
<aside class="app-sidebar">
  <div class="side-header" style="border: none;">
    <a class="header-brand1" href="<?php echo base_url().'doctor/dashboard/'?>">
  ...
  <ul class="side-menu">
    ...
    <!-- <li class="slide">
      <a class="side-menu__item" href="<?php //echo base_url().'doctor/dashboard/'?>">
    ...
    <li class="slide">
      <a class="side-menu__item" href="<?php echo base_url().'doctor/bookings/'?>">
